...
| ----- | --- | -------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 10:00 | 5   | **Hook + intro**                                   | Open with the problem: a chatbot that confidently lies about your business. Show the GenAI landscape slide. Frame today: build a bot that _only_ speaks truth from your docs.                                                                                                    |
| 10:05 | 5   | **The Gemini landscape**                           | Quick tour: Gemini 3.5 Flash (fast, cheap default) and 3.1 Pro (deep reasoning), multimodal, grounding, File Search. Keep it light - founders care about _what it unlocks_, not model specs.                                                                                     |
...
- [ ] **Dry run the entire build** in AI Studio on the actual venue wifi. UI labels change weekly — confirm where the **+ attach**, **Tools / Grounding**, and **Get code** controls live _today_.
...
- [ ] Have your **demo question** picked, where the raw model hallucinates but your doc has the answer. The repo's `README.md` lists tested demo questions (e.g. _"What's Interstellar Labs' refund window for annual plans?"_ → 14 days).
